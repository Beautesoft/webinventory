...
{
    public partial class GRNReturn : System.Web.UI.Page
    {
        #region Declaration
        ...
        private void LoadValue()
        {
            ...
            try
            {
                ...
                ddl_supplierGRNReturn.Items.Add(new ListItem("Select your option", ""));
                foreach (DataRow oDr in oDT_General.Rows)
                {
                    ddl_supplierGRNReturn.Items.Add(new ListItem(oDr["supplydesc"].ToString().Trim(), oDr["splyCode"].ToString().Trim()));
                }
                ...
                ddlCreatedBy_GRNReturn.Items.Add(new ListItem("Select your option", ""));
                foreach (DataRow oDr in oDT_General.Rows)
                {
                    ddlCreatedBy_GRNReturn.Items.Add(new ListItem(oDr["empName"].ToString().Trim(), oDr["empCode"].ToString().Trim()));
                }
                ...
                //ddlStoreCode_GRNReturn.Items.Add(new ListItem("Select your option", ""));
                foreach (DataRow oDr in oDT_General.Rows)
                {
                    ddlStoreCode_GRNReturn.Items.Add(new ListItem(oDr["itemsiteDesc"].ToString().Trim(), oDr["itemsiteCode"].ToString().Trim()));
                }
                //ddlStoreCode_GRNReturn.Value= System.Configuration.ConfigurationManager.AppSettings["SiteCode"];
        ...
        public static void AddStkMovdocHdrsData(List<StkMovdocHdrsInput> Details)
        {
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                //GET Method  
                string codeDesc = "Goods Return Note";
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    List<ControlNos> GRNReturn = JsonConvert.DeserializeObject<List<ControlNos>>(a);
                    Details[0].docNo = GRNReturn[0].controlPrefix + GRNReturn[0].siteCode + GRNReturn[0].controlNo;
                }
                else
                {
        ...
        public static void AddStkMovdocDtlsData(List<StkMovdocDtls> Details)
        {
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    List<ControlNos> GRNReturn = JsonConvert.DeserializeObject<List<ControlNos>>(a);
                    Details[0].docNo = GRNReturn[0].controlPrefix+ GRNReturn[0].siteCode + GRNReturn[0].controlNo;
                    Details[0].RunningNo =  GRNReturn[0].controlNo;
                }
                else
                {
                    Console.WriteLine("Internal server Error");
                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            ControlNosUpdate c = new ControlNosUpdate { controldescription = "Goods Return Note", sitecode = (string)HttpContext.Current.Session["User_SiteCode"], controlnumber = Convert.ToString(NewcontrolNo) };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["PKey"] != null)
                {
                    ...
                    btnSubmit_AddGRNReturn.InnerText = "Save";
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            txtDocNo_GRNReturn.Value = StkMovdocHdrsVal[0].docNo;
                            
                            dt_DocDateGRNReturn.Value =Convert.ToDateTime(StkMovdocHdrsVal[0].docDate.ToString().Substring(0, 10)).ToString("dd/MM/yyyy");
                            if (StkMovdocHdrsVal[0].docStatus == "0")
                            {
                                txtStatus_GRNReturn.Value = "Open";
                            }
                            else
                            {
                                txtStatus_GRNReturn.Value = "Posted";
                            }
                            
                            ddl_supplierGRNReturn.Value = StkMovdocHdrsVal[0].supplyNo;
                            if (StkMovdocHdrsVal[0].recExpect != null)
                            {
                                dt_DeliveryDateGRNReturn.Value = Convert.ToDateTime(StkMovdocHdrsVal[0].recExpect.ToString().Substring(0, 10)).ToString("dd/MM/yyyy");
                            }
                            txtTerm_GRNReturn.Value = StkMovdocHdrsVal[0].docTerm;
                            txtPO1Ref_GRNReturn.Value = StkMovdocHdrsVal[0].docRef1;
                            ddlStoreCode_GRNReturn.Value = StkMovdocHdrsVal[0].storeNo;
                            txtGrn1Ref_GRNReturn.Value = StkMovdocHdrsVal[0].docRef2;
                            ddlCreatedBy_GRNReturn.Value = StkMovdocHdrsVal[0].staffNo;
                            txtRemark_GRNReturn.Value = StkMovdocHdrsVal[0].docRemk1;
                            txt_TotAmntGRNReturn.Value = string.Format("{0:0.00}", Convert.ToDecimal(StkMovdocHdrsVal[0].docAmt));
                            txtAttnTo_GRNReturn.Value = StkMovdocHdrsVal[0].docAttn;
                            txtAddress1_GRNReturn.Value = StkMovdocHdrsVal[0].baddr1;
                            txtShipToAddress1_GRNReturn.Value = StkMovdocHdrsVal[0].daddr1;
                            txtAddress2_GRNReturn.Value = StkMovdocHdrsVal[0].baddr2;
                            txtShipToAddress2_GRNReturn.Value = StkMovdocHdrsVal[0].daddr2;
                            txtAddress3_GRNReturn.Value = StkMovdocHdrsVal[0].baddr3;
                            txtShipToAddress3_GRNReturn.Value = StkMovdocHdrsVal[0].daddr3;
                            txtPostCode_GRNReturn.Value = StkMovdocHdrsVal[0].bpostcode;
                            txtPostCodeTo_GRNReturn.Value = StkMovdocHdrsVal[0].dpostcode;
                            txtCity_GRNReturn.Value = StkMovdocHdrsVal[0].bcity;
                            txtCityTo_GRNReturn.Value = StkMovdocHdrsVal[0].dcity;
                            txtState_GRNReturn.Value = StkMovdocHdrsVal[0].bstate;
                            txtStateTo_GRNReturn.Value = StkMovdocHdrsVal[0].dstate;
                            txtCountry_GRNReturn.Value = StkMovdocHdrsVal[0].bcountry;
                            txtCountryTo_GRNReturn.Value = StkMovdocHdrsVal[0].dcountry;
                            txtRemark1_GRNReturn.Value = StkMovdocHdrsVal[0].docRemk2;
                            txtRemark2_GRNReturn.Value = StkMovdocHdrsVal[0].docRemk3;
                            recStatus = StkMovdocHdrsVal[0].recStatus;
                            if (StkMovdocHdrsVal[0].docStatus == "0")
                            {
                                btnSubmit_AddGRNReturn.Disabled = false;
                                btnSubmit_PostGRNReturn.Disabled = false;
                            }
                            else
                            {
                                btnSubmit_AddGRNReturn.Disabled = true;
                                btnSubmit_PostGRNReturn.Disabled = true;
                            }
                        }
                        else
                        {
                    ...
                    if (StkMovdocDtlsVal.Count > 0 && GRNReturnEntryModule.Rows.Count == 1)
                    {
                        for (int i = 0; i < StkMovdocDtlsVal.Count; i++)
                        {
                            ...
                            //Col_15.InnerHtml = "<input type='hidden' class=form-control' value=" + StkMovdocDtlsVal[i].docId + " id='txthiddenId_GRNReturnDtl' runat='server'>";
                            ...
                            Col_11.InnerHtml = "<div class='tools'><i class='edit_AddItemToGRNReturn glyphicon glyphicon-pencil'></i></div>";
                            ...
                            if (recStatus == "0")
                            {
                                ...
                                Col_12.InnerHtml = "<div class='tools'><i class='Remove_AddItemToGRNReturnAfterSave glyphicon glyphicon-trash'></i></div>";
                            ...
                            GRNReturnEntryModule.Rows.Add(_Row);
                        }
                    }
                ...
                {
                    btnSubmit_AddGRNReturn.InnerText = "Add";
                    txtStatus_GRNReturn.Value = "Open";
                    _PKey = "";
                    //FetchRecordAsync();
                    dt_DocDateGRNReturn.Value = DateTime.Now.ToString("dd/MM/yyyy");
                    //dt_DeliveryDateGRNReturn.Value = DateTime.Now.ToString("dd/MM/yyyy");
                }
