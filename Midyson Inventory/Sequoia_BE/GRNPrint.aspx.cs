    ...
    public partial class GRNPrint : System.Web.UI.Page
    {
        ...
        private void LoadPageInformations(string _PKey1)
        {
            try
            {
                ...
                this.rv_webBI_GRNPrint.LocalReport.DataSources.Clear();
                this.rv_webBI_GRNPrint.LocalReport.DataSources.Add(rds);
                ...
                string postData1Title = "{\"fromDate\":\"" + strFromDate.Trim() + "\"," +
                     ...
                     "\"ReportTitle\":\"" + " Goods Receive Note Print " + "\"," +
                ...
                this.rv_webBI_GRNPrint.LocalReport.DataSources.Add(titledatasource);
                ...
                this.rv_webBI_GRNPrint.LocalReport.DataSources.Add(Logodatasource);

                this.rv_webBI_GRNPrint.LocalReport.ReportPath = "rpt_webGRN.rdlc";
                this.rv_webBI_GRNPrint.LocalReport.Refresh();
                this.rv_webBI_GRNPrint.SizeToReportContent = true;
                this.rv_webBI_GRNPrint.Width = Unit.Percentage(100);
                this.rv_webBI_GRNPrint.Height = Unit.Percentage(100);
                this.rv_webBI_GRNPrint.AsyncRendering = false;
                this.rv_webBI_GRNPrint.ZoomMode = ZoomMode.FullPage;
