...
{
    public partial class StockADJPrint : System.Web.UI.Page
    {
        ...
        private void LoadPageInformations(string _PKey1)
        {
            try
            {
                ...
                this.rv_webBI_StkAdjPrint.LocalReport.DataSources.Clear();
                this.rv_webBI_StkAdjPrint.LocalReport.DataSources.Add(rds);
                ...
                string postData1Title = "{\"fromDate\":\"" + strFromDate.Trim() + "\"," +
                     ...
                     "\"ReportTitle\":\"" + " Adjustment Stock Print " + "\"," +
                ...
                this.rv_webBI_StkAdjPrint.LocalReport.DataSources.Add(titledatasource);
                ...
                this.rv_webBI_StkAdjPrint.LocalReport.DataSources.Add(Logodatasource);

                this.rv_webBI_StkAdjPrint.LocalReport.ReportPath = "rpt_webGRNADJ.rdlc";
                this.rv_webBI_StkAdjPrint.LocalReport.Refresh();
                this.rv_webBI_StkAdjPrint.SizeToReportContent = true;
                this.rv_webBI_StkAdjPrint.Width = Unit.Percentage(100);
                this.rv_webBI_StkAdjPrint.Height = Unit.Percentage(100);
                this.rv_webBI_StkAdjPrint.AsyncRendering = false;
                this.rv_webBI_StkAdjPrint.ZoomMode = ZoomMode.FullPage;
