...
{
    public partial class GRNOutPrint : System.Web.UI.Page
    {
        ...
        private void LoadPageInformations(string _PKey1)
        {
            try
            {
                ...
                this.rv_webBI_GRNOutPrint.LocalReport.DataSources.Clear();
                this.rv_webBI_GRNOutPrint.LocalReport.DataSources.Add(rds);
                ...
                this.rv_webBI_GRNOutPrint.LocalReport.DataSources.Add(titledatasource);
                ...
                this.rv_webBI_GRNOutPrint.LocalReport.DataSources.Add(Logodatasource);

                this.rv_webBI_GRNOutPrint.LocalReport.ReportPath = "rpt_webGRNOut.rdlc";
                this.rv_webBI_GRNOutPrint.LocalReport.Refresh();
                this.rv_webBI_GRNOutPrint.SizeToReportContent = true;
                this.rv_webBI_GRNOutPrint.Width = Unit.Percentage(100);
                this.rv_webBI_GRNOutPrint.Height = Unit.Percentage(100);
                this.rv_webBI_GRNOutPrint.AsyncRendering = false;
                this.rv_webBI_GRNOutPrint.ZoomMode = ZoomMode.FullPage;
