...
{
    public partial class ConfigInterface_VOIDTransactionReason : System.Web.UI.Page
    {
        ...
        private void Get_ControlPrefixs()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                //GET Method  
                string api = "api/ControlNos?filter={\"where\":{\"controlDescription\":\"VOID REASON\"}}";
        ...
        protected void Get_VOIDTransactionReasons()
        {

            //HttpWebRequest WebReq = (HttpWebRequest)WebRequest.Create(string.Format("http://103.253.14.203:3000/api/VoidReasons"));
            HttpWebRequest WebReq = (HttpWebRequest)WebRequest.Create(string.Format(System.Configuration.ConfigurationManager.AppSettings["uri"] + "api/VoidReasons"));
            WebReq.Method = "GET";
            ...
            List<VoidReasonUpdate> items = new List<VoidReasonUpdate>();
            items = JsonConvert.DeserializeObject<List<VoidReasonUpdate>>(jsonString);
            ...
            for (int i = 0; i < items.Count; i++)
            {
                ...
                {
                    Col_3.InnerHtml = "<input type='checkbox' class='chk_VOIDTransactionReason editor - active'>";
                }
                ...
                Col_Action.InnerHtml = "<div class='tools'><i class='edit_VOIDTransactionReason glyphicon glyphicon-pencil'></i></div>";
                ...
                Col_4.Attributes.Add("style", "width: 0px; display:none");
                _Row.Controls.Add(Col_4);
                tblVOIDTransactionReason.Rows.Add(_Row);
