...
{
    public partial class PoAppPrint : System.Web.UI.Page
    {
        ...
        private void LoadPageInformations(string _PKey1)
        {
            try
            {
                HttpWebRequest WebReq = (HttpWebRequest)WebRequest.Create(string.Format(System.Configuration.ConfigurationManager.AppSettings["uri"] + "api/Poappprintlists"));
                WebReq.Method = "GET";
                ...
                if (_PKey1 != "")
                {
                    ...
                    oDV.RowFilter = "GrnNo='" + _PKey1 + "'";
                    oDT_Header = oDV.ToTable();
                }

                //oDT_Header = (DataTable)JsonConvert.DeserializeObject(jsonString, (typeof(DataTable)));
                ReportDataSource rds = new ReportDataSource("ds_POPrintList", oDT_Header);
                ...
                string postData1Title = "{\"fromDate\":\"" + strFromDate.Trim() + "\"," +
                     ...
                     "\"ReportTitle\":\"" + " Stock Transfer Out " + "\"," +
                ...
                this.rv_webBI_InvoicePrint.LocalReport.ReportPath = "rpt_webBI_stkTrnf.rdlc";
