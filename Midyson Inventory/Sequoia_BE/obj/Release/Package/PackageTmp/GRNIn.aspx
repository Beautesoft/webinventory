                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                             <div class="form-group required">
                                ...
                                <input type="text" runat="server" class="form-control pull-right" id="dt_DocDateGRNIn"  readonly="readonly">
                            </div>
                            </div>
                     </div>  
                                            <div class="col-md-4">
                ...
                <br />
                    ...
                    <tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                   <input type="number" maxlength="50" runat="server" class="form-control" id="txt_TotAmntGRNIn" style="text-align:left;font-weight:bold" readonly="readonly">
                                </div>
                                <div class="col-md-2">
