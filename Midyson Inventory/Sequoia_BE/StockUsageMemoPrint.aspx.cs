...
{
    public partial class StockUsageMemoPrint : System.Web.UI.Page
    {
        ...
        private void LoadPageInformations(string _PKey1)
        {
            try
            {
                ...
                this.rv_webBI_StockUsageMemoPrint.LocalReport.DataSources.Clear();
                this.rv_webBI_StockUsageMemoPrint.LocalReport.DataSources.Add(rds);
                ...
                string postData1Title = "{\"fromDate\":\"" + strFromDate.Trim() + "\"," +
                     ...
                     "\"ReportTitle\":\"" + " Stock Usage Memo Print " + "\"," +
                ...
                this.rv_webBI_StockUsageMemoPrint.LocalReport.DataSources.Add(titledatasource);
                ...
                this.rv_webBI_StockUsageMemoPrint.LocalReport.DataSources.Add(Logodatasource);

                this.rv_webBI_StockUsageMemoPrint.LocalReport.ReportPath = "rpt_webGRNUsageMemo.rdlc";
                this.rv_webBI_StockUsageMemoPrint.LocalReport.Refresh();
                this.rv_webBI_StockUsageMemoPrint.SizeToReportContent = true;
                this.rv_webBI_StockUsageMemoPrint.Width = Unit.Percentage(100);
                this.rv_webBI_StockUsageMemoPrint.Height = Unit.Percentage(100);
                this.rv_webBI_StockUsageMemoPrint.AsyncRendering = false;
                this.rv_webBI_StockUsageMemoPrint.ZoomMode = ZoomMode.FullPage;
